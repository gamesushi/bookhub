...
如果从合伙企业获得的收入可能在您的总收入中占很大比重（比如说，按市值计算，占您所有权益资产的 15%或 20%），那么在编制 1964 年季度估算时，安全的做法是根据 1963 年的实际税额进行纳税。在我的个人报税表中，我始终遵循这一程序。这样可以避免因[[低估]]税额而可能受到的处罚。你需要对合伙企业收入的相应份额进行季度预估，并承担相应责任。如果您当年的估算额与上一年实际缴纳的税额相同，您就不会因[[低估]]税额而受到处罚。
